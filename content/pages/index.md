  ...
  - colors: colors-h
    ...
    items:
      - type: FeaturedItem
        title: 
        text: >-
            <iframe width="100%" height="480" src="https://www.youtube.com/embed/VQlyAtvGajY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        featuredImage: null
        styles:
          title:
            textAlign: center
